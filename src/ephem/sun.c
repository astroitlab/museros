 ...
 */
   ...
   const double hour = 0.;
   const double ut1_utc = 0.03811;
   
   const double latitude = 42.2087; //115.246;
   const double longitude = 115.246;
   const double height = 1356.0;
   const double temperature = 10.0;
   const double pressure = 1010.0;
      
   const double x_pole = 0.1673;
   const double y_pole = +0.3248;
...
*/
   ...
   if ((error = make_object (0,10,"Sun",&dummy_star, &moon)) != 0)
   {
