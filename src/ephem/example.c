 ...
 */
   ...
   const short int year = 2012;
   const short int month = 11;
   const short int day = 21;
   const short int leap_secs = 35;
   const short int accuracy = 0;
   short int error = 0;
   short int de_num = 0;
   
   const double hour = 6.77539833333;
   //double ut1_utc = .318725; /* -0.387845;*/
   
   const double latitude = 42.21183333333333;
   const double longitude = 115.2505;
   const double height = 1365;
   const double temperature = 10.0;
   const double pressure = 1010.0;
      
   const double x_pole = 0.12633;
   const double y_pole = 0.30368;
...
*/
   ...
   if ((error = make_object (0,11,"Jupiter",&dummy_star, &moon)) != 0)
   {
...
*/
   ...
   /*cel_pole(jd_tt, 2, x_pole, y_pole); */
...
*/
   ...
   printf ("Sun geocentric and topocentric positions:\n");
