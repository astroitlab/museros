...
if __name__ == '__main__':
    redisStr = "192.168.5.84:6379"
    redisIpAndPort = redisStr.split(":")
    print RedisCache().muser_get_flag("1","2015-12-01 00:00:00")
    line = RedisCache().muser_get_global("observatory","2015-12-01 00:00:00")['result'][0]
