...
def onedgaussfit(xax, data, err=None,
                 ...
                 limitedmin=[False, False, False, True], limitedmax=[False, False, False, False],
...
def gaussian(height, amplitude, center_x, center_y, width_x, width_y, rotation):
...
def moments2(data):
    ...
    #height = data.max()
    height = median(data.ravel())
    amplitude = data.max()-height
    return height, amplitude, x, y, width_x, width_y, 0.0
