...
class Body(object):
    ...
    def _position(self, tdb, tdb2=0.0):
        segment = self.kernel.spk[0, self.code]
        return segment.compute(tdb, tdb2)

    def _position_and_velocity(self, tdb, tdb2=0.0):
        segment = self.kernel.spk[0, self.code]
...
class Earth(Planet):
    ...
    def satellite(self, text):
        from pyephem.sgp4lib import EarthSatellite
...
class Ephemeris(object):
    ...
    def __init__(self, module):
        ...
        self.jplephemeris = ephem.Ephemeris(module)
