...
def debugMsg(*args):
	try:
		if _asf_debug:
			print "DEBUG:"
			#print "DEBUG:",string.join(map(str,args)),TermColors.Normal
	except:
		pass
...
# ip = ipget()  #IPython.core.hooks()

ip = IPython.core.getipython.get_ipython()
ip.input_splitter.logical_line_transforms.append(assignmentFilter())
ip.input_transformer_manager.logical_line_transforms.append(assignmentFilter())

# IPython.core.hooks.input_prefilter = assignmentFilter
#ip.set_hook('input_prefilter',assignmentFilter)
#IPython.core.hooks.input_prefilter()
#
