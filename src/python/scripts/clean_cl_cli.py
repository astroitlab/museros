...
from types import *
from task_clean_cl import clean
import globalpy
...
class clean_cl_cli_:
    ...
    def __init__(self) :
       self.__bases__ = (clean_cl_cli_,)
       self.__doc__ = self.__call__.__doc__

       self.parameters={'inputfile':None, 'outdir':None, 'fits':None, 'plot':None, 'correct':None,'debug':None, }
    ...
    def __call__(self, inputfile=None, outdir=None, fits=None, plot=None, correct=None, debug=None, ):
	...
	#muserlog = muserc.muserc.logsink()
        self.__globals__['__last_task'] = 'clean_cl'
        self.__globals__['taskname'] = 'clean_cl'
        ###
...
#
	...
	try :
	    ...
	    #return False
          ...
          #     saveinputs=''
          # else:
          #     saveinputs('clean_cl', 'clean_cl.last', myparams, self.__globals__,scriptstr=scriptstr)
          tname = 'clean_cl'
          spaces = ' '*(18-len(tname))
          # muserlog.post('\n##########################################'+
          ...
          result = clean(inputfile, outdir, fits, plot, correct, debug)
...
#
	...
	if not hasattr(self, "__globals__") or self.__globals__ == None :
        ...
        paramgui.runTask('clean_cl', myf['_ip'])
        paramgui.setGlobals({})
...
#
#
    def description(self, key='clean_cl', subkey=None):
        desc={'clean_cl': 'Hogbom Clean Algorithm',
               'inputfile': 'Name of input MUSER visibility file',
...
#
    ...
    def itsdefault(self, paramname) :
        a = {}
        a['inputfile']  = '/astrodata/archive/20151101/MUSER-1/uvfits/20151101-120849_354161240.uvfits'
        a['outdir']  = ''
        a['fits']  = False
        a['plot']  = True
        a['correct']  = False
