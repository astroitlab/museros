...
from types import *
from task_dispfits import dispfits
from task_dispfits import dispfits
import globalpy
...
class dispfits_cli_:
	...
	Example :
        ...
        dispfits(mirfile='ngc5921.uv', vis='ngc5921.ms',tsys=True)
        ...
        self.__globals__['__last_task'] = 'dispfits'
        self.__globals__['taskname'] = 'dispfits'
        ###
...
#
        ...
        try :
            ...
            if type(self.__call__.func_defaults) is NoneType:
                ...
                saveinputs('dispfits', 'dispfits.last', myparams, self.__globals__,scriptstr=scriptstr)
            tname = 'dispfits'
            spaces = ' '*(18-len(tname))
            muserlog.post('\n##########################################'+
            ...
            result = dispfits(muser, start, debug)
...
#
    def paramgui(self, useGlobals=True, ipython_globals=None):
        ...
        paramgui.runTask('dispfits', myf['_ip'])
        paramgui.setGlobals({})
...
#
#
    def description(self, key='dispfits', subkey=None):
        desc={'dispfits': 'List all files information with the specified date',
                'muser':'Muser subarray 1 or 2',
               'start': 'The start date and time of the observational data',
               'debug': 'Display1 increasingly verbose debug messages'
              }
