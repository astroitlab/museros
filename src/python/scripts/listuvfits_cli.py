...
from types import *
from task_listuvfits import listuvfits
import globalpy
...
class listuvfits_cli_:
    ...
    def __init__(self) :
       self.__bases__ = (listuvfits_cli_,)
	...
	Example :
        ...
        listuvfits(muser=1, start='2015-11-1')
        ...
        self.__globals__['__last_task'] = 'listuvfits'
        self.__globals__['taskname'] = 'listuvfits'
        ###
...
#
        ...
        try :
            ...
            if type(self.__call__.func_defaults) is NoneType:
                ...
                saveinputs('listuvfits', 'listuvfits.last', myparams, self.__globals__,scriptstr=scriptstr)
            tname = 'listuvfits'
            spaces = ' '*(18-len(tname))
            muserlog.post('\n##########################################'+
            ...
            result = listuvfits(muser, start, debug)
...
#
    def paramgui(self, useGlobals=True, ipython_globals=None):
        ...
        paramgui.runTask('listuvfits', myf['_ip'])
        paramgui.setGlobals({})
...
#
#
    def description(self, key='listuvfits', subkey=None):
        desc={'listuvfits': 'List all files information with the specified date',
...
listuvfits_cli = listuvfits_cli_()
